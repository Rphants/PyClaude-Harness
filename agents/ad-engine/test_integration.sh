...
echo "1. Testing preflight.py --mode creatives"
python3 preflight.py --mode creatives --json > /tmp/preflight.json
echo "   ✓ Preflight completed"
echo ""

echo "2. Testing harness_bridge.py --propose"
...
echo "3. Testing harness_bridge.py --evaluate"
